...
public partial class InfoPanelController : Control
{
    ...
    [Export] public required SpinBox NumberOfSymbols { get; set; }

    [Export] public required SpinBox NumberOfSpecies { get; set; }

    [Export] public SpeciesItem SpeciesItem { get; set; }

    [Export] private GridContainer SpeciesGrid { get; set; }
    ...
    public void OnInformationChanged(object? o, EventArgs args)
    {
        ...
        foreach (var attributes in data.PlantAttributes) ListSpecies(attributes);
    ...
    public void ListSpecies(PlantAttributes attributes)
    {
        ...
        button.Pressed += () => { ShowSpecies(attributes); };
